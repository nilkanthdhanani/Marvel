...
import { apple, more, musicBox1, play, playGray, upRightArrow } from '../../../../assets/images/imageJS/podcastImg';

export default function MusicBox1() {
    return (
        <>
                ...
                <div className="music-box-main">
                    <div className="music-box-main1">
                        ...
                        <div className="music-box-poster">
                            <img src={musicBox1} alt="musicBox1" />
                        </div>
                        <div className="music-box-text">
                            <div className="music-box-text-main">
                                <h4>The Official Marvel Podcast</h4>
                                <span>Marvel</span>
                            </div>
