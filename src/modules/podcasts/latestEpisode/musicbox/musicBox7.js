...
import { apple, more, musicBox7, play, playGray, upRightArrow } from '../../../../assets/images/imageJS/podcastImg';

export default function MusicBox7() {
    return (
        <>
            <div className="music-box">
                <h3>Marvel's Wastelanders: Hawkeye</h3>
                <div className="music-box-main">
                    <div className="music-box-main1">
                        ...
                        <div className="music-box-poster">
                            <img src={musicBox7} alt="musicBox7" />
                        </div>
                        <div className="music-box-text">
                            <div className="music-box-text-main">
                                <h4>Marvel's Wastelanders: Hawkeye</h4>
