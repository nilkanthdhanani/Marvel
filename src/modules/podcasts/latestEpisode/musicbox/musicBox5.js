...
import { apple, more, musicBox5, play, playGray, upRightArrow } from '../../../../assets/images/imageJS/podcastImg';

export default function MusicBox5() {
    return (
        <>
            <div className="music-box">
                <h3>The History of Marvel Comics: Black Panther</h3>
                <div className="music-box-main">
                    <div className="music-box-main1">
                        ...
                        <div className="music-box-poster">
                            <img src={musicBox5} alt="musicBox5" />
                        </div>
                        <div className="music-box-text">
                            <div className="music-box-text-main">
                                <h4>The History of Marvel Comics: Black Panther</h4>
