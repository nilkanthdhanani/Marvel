...
import { apple, more, musicBox8, play, playGray, upRightArrow } from '../../../../assets/images/imageJS/podcastImg';

export default function MusicBox8() {
    return (
        <>
            <div className="music-box">
                <h3>Marvel's Wastelanders: Star-Lord</h3>
                <div className="music-box-main">
                    <div className="music-box-main1">
                        ...
                        <div className="music-box-poster">
                            <img src={musicBox8} alt="musicBox8" />
                        </div>
                        <div className="music-box-text">
                            <div className="music-box-text-main">
                                <h4>Marvel's Wastelanders: Star-Lord</h4>
                ...
                <div class="banner-content-button">
                    ...
                    <button><span>VIEW ARCHIVE</span><div class="inner-cut"></div></button>
                </div>
            </div>
        </>
    )
